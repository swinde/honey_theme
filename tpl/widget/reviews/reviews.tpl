        ...
        <div class="panel panel-default">
            <div class="panel-heading toggle-accordion">
                <div class="h4 panel-title">
                    [{if $oxcmp_user}]
                        <i class="fas fa-pencil"></i> <a id="writeNewReview" data-toggle="collapse" data-parent="#review_form_accordion" href="#review_form">[{oxmultilang ident="WRITE_REVIEW"}]</a>
                    [{else}]
                        <i class="fas fa-user"></i> <a id="reviewsLogin" rel="nofollow" href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=account" params="anid=`$oDetailsProduct->oxarticles__oxnid->value`"|cat:"&amp;sourcecl=details"|cat:$oViewConf->getNavUrlParams()}]">[{oxmultilang ident="MESSAGE_LOGIN_TO_WRITE_REVIEW"}]</a>
                    [{/if}]
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 rating">
                                    [{if $review->oxreviews__oxrating->value}]
                                        <div class="float-sm-right text-warning" itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating">
