                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    [{if $address->isSelected()}]
                                        <button class="btn btn-warning btn-xs hasTooltip float-sm-right dd-edit-shipping-address" title="[{oxmultilang ident="CHANGE"}]">
                                ...
                                <div class="panel-footer" >
                                    <label class="btn btn-outline-dark btn-block[{if $address->isSelected()}] active[{/if}]">
                                        <input type="radio" name="oxaddressid" value="[{$address->oxaddress__oxid->value}]" class="hidden" autocomplete="off" [{if $address->isSelected()}]checked[{/if}]><i class="fas fa-check"></i> [{oxmultilang ident="DD_USER_SHIPPING_SELECT_ADDRESS"}]
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default dd-add-delivery-address">
                            ...
                            <div class="panel-footer" >
                                <label class="btn btn-outline-dark btn-block">
                                    <input type="radio" name="oxaddressid" value="-1" class="hidden" autocomplete="off"><i class="fas fa-check"></i> [{oxmultilang ident="DD_USER_SHIPPING_SELECT_ADDRESS"}]
                                </label>
                            </div>
                        </div>
                    </div>
