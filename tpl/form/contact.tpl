...
<form class="form-horizontal" action="[{$oViewConf->getSslSelfLink()}]" method="post" role="form" novalidate="novalidate">
    ...
    <div class="form-group row[{if $aErrors.oxuser__oxfname}] oxInValid[{/if}]">
    ...
    <div class="form-group row[{if $aErrors.oxuser__oxlname}] oxInValid[{/if}]">
    ...
    <div class="form-group row[{if $aErrors && !$oView->getContactSubject()}] oxInValid[{/if}]">
    ...
    <div class="form-group row">
        <div class="offset-lg-2 col-lg-10">
            ...
            <button class="btn btn-primary" type="submit">
                <i class="fas fa-envelope"></i> [{oxmultilang ident="SEND"}]
            </button>
        </div>
    </div>
</form>
