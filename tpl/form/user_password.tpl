...
<form class="js-oxValidate form-horizontal" action="[{$oViewConf->getSelfActionLink()}]" name="changepassword" method="post" novalidate="novalidate">
    ...
    <div class="hidden">
        ...
        <div class="form-group[{if $aErrors.oxuser__oxpassword}] oxInValid[{/if}] row">
            <label class="col-form-label col-lg-3" for="passwordOld">[{oxmultilang ident="OLD_PASSWORD"}]</label>
            <div class="col-lg-5">
        ...
        <div class="form-group[{if $aErrors.oxuser__oxpassword}] oxInValid[{/if}] row">
            <label class="col-form-label col-lg-3" for="passwordNew">[{oxmultilang ident="NEW_PASSWORD"}]</label>
            <div class="col-lg-5">
        ...
        <div class="form-group[{if $aErrors.oxuser__oxpassword}] oxInValid[{/if}] row">
            <label class="col-form-label col-lg-3" for="passwordNewConfirm">[{oxmultilang ident="CONFIRM_PASSWORD"}]</label>
            <div class="col-lg-5">
