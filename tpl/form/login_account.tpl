...
<div class="row">
    <div class="col-12 col-md-6 float-sm-right">
        <div class="card">
            ...
            <div class="card-body">
                <form name="login" class="js-oxValidate form-horizontal" action="[{$oViewConf->getSslSelfLink()}]" method="post" novalidate="novalidate">
                    ...
                    <p class="card-text">[{oxmultilang ident="LOGIN_ALREADY_CUSTOMER"}]</p>

                    <div class="form-group[{if $aErrors}] oxInValid[{/if}] row">
                        <label class="req col-form-label col-lg-3">[{oxmultilang ident="EMAIL"}]</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group[{if $aErrors}] oxInValid[{/if}] row">
                        <label class="req col-form-label col-lg-3">[{oxmultilang ident="PASSWORD"}]</label>
                        <div class="col-lg-9">
    ...
    <div class="col-12 col-md-6 float-sm-left">
        <div class="card">
            <div class="card-header">[{oxmultilang ident="DD_LOGIN_ACCOUNT_PANEL_CREATE_TITLE"}]</div>
            <div class="card-body">
                <p class="card-text">[{oxmultilang ident="DD_LOGIN_ACCOUNT_PANEL_CREATE_BODY"}]</p>
                <a class="card-text" id="openAccountLink" href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=register"}]" class="btn btn-primary btn-block" role="button">[{oxmultilang ident="OPEN_ACCOUNT"}]</a><br />
            </div>
        </div>
        <div class="clearfix"></div>
    </div>
