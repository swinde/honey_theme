                    ...
                    [{block name="checkout_basketcontents_basketitem_titlenumber"}]
                        ...
                        <td>
                            [{block name="checkout_basketcontents_basketitem_image"}]
                                [{* product image *}]
                                <div class="float-sm-left basketImage">
                        ...
                        [{if $oView->isWrapping()}]
                            <td align="center">
                                ...
                                [{else}]
                                    ...
                                    [{if $editable}]
                                        <a class="btn btn-outline-dark btn-xs" href="#" title="[{oxmultilang ident="ADD"}]" data-toggle="modal" data-target="#giftoptions"><i class="fas fa-pencil"></i> [{$oWrap->oxwrapping__oxname->value}]</a>
                                    [{else}]
