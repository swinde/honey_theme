...
<form name="basket[{$basketindex}]" id="basket_form" action="[{$oViewConf->getSelfActionLink()}]" method="post">
    ...
    <div class="d-block d-sm-none" id="basketcontents_list">
        [{include file="page/checkout/inc/basketcontents_list.tpl"}]
    </div>
    [{* Für alle Geräte >=768px sichtbar *}]
    <div class="d-none d-sm-block" id="basketcontents_table">
...
[{if $oViewConf->getShowVouchers() && $oViewConf->getActiveClassName() == 'basket'}]
    [{block name="checkout_basket_vouchers"}]
        <div id="basketVoucher" class="float-sm-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="submit" class="btn btn-primary submitButton"><i class="fas fa-gift"></i> [{oxmultilang ident="REDEEM_COUPON"}]</button>
                            </span>
                        </div>
...
[{block name="checkout_basketcontents_summary"}]
    <div id="basketSummary" class="float-sm-right summary[{if $oViewConf->getActiveClassName() == 'order'}] orderSummary[{/if}]">
        [{*  basket summary  *}]
