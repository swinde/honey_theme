                            ...
                            [{if $oView->isWrapping()}]
                                <div class="wrapping">
                                    ...
                                    [{else}]
                                        ...
                                        [{if $editable}]
                                            <small>[{oxmultilang ident="WRAPPING"}]:</small> <a class="btn btn-outline-dark btn-xs" href="#" title="[{oxmultilang ident="ADD"}]" data-toggle="modal" data-target="#giftoptions"><i class="fas fa-pencil"></i> [{$oWrap->oxwrapping__oxname->value}]</a>
                                        [{else}]
                ...
                <div class="row toggable" style="display:none;">
                    ...
                    <div class="col-9 text-right">
                        [{block name="checkout_basketcontents_basketitem_quantity"}]
                            ...
                            <div class="quantity float-sm-right">
                                [{if $editable}]
                                    ...
                                    [{if !$basketitem->isBundle() || !$basketitem->isDiscountArticle()}]
                                        <div class="input-group input-group-sm">
                                            ...
                                            <span class="input-group-btn">
                                                <button class="btn btn-sm btn-warning float-sm-right" id="basketUpdate" type="submit" name="updateBtn" title="[{oxmultilang ident="UPDATE"}]">
