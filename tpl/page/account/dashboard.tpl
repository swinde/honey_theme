                ...
                [{block name="account_dashboard_col1"}]
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <a href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=account_password"}]" class="btn btn-outline-dark btn-xs float-sm-right">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <a href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=account_newsletter"}]" class="btn btn-outline-dark btn-xs float-sm-right">
                                <i class="fas fa-arrow-right"></i>
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <a href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=account_user"}]" class="btn btn-outline-dark btn-xs float-sm-right">
                                <i class="fas fa-arrow-right"></i>
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <a href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=account_order"}]" class="btn btn-outline-dark btn-xs float-sm-right">
                                <i class="fas fa-arrow-right"></i>
                            </a>
                        </div>
                    ...
                    [{if $oView->isEnabledDownloadableFiles()}]
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <a href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=account_downloads"}]" class="btn btn-outline-dark btn-xs float-sm-right">
                                    <i class="fas fa-arrow-right"></i>
                                </a>
                            </div>
                ...
                [{block name="account_dashboard_col2"}]
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <a href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=account_noticelist"}]" class="btn btn-outline-dark btn-xs float-sm-right">
                                <i class="fas fa-arrow-right"></i>
                            </a>
                        </div>
                    ...
                    [{if $oViewConf->getShowWishlist()}]
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <a href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=account_wishlist"}]" class="btn btn-outline-dark btn-xs float-sm-right">
                                    <i class="fas fa-arrow-right"></i>
                                </a>
                            </div>
                    ...
                    [{if $oViewConf->getShowCompareList()}]
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <a href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=compare"}]" class="btn btn-outline-dark btn-xs float-sm-right">
                                    <i class="fas fa-arrow-right"></i>
                                </a>
                            </div>
                    ...
                    [{if $oViewConf->getShowListmania()}]
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <a href="[{oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=account_recommlist"}]" class="btn btn-outline-dark btn-xs float-sm-right">
                                    <i class="fas fa-arrow-right"></i>
                                </a>
                            </div>
    ...
    <div class="row">
        <div class="col-12 text-right">
            <a href="[{$oViewConf->getLogoutLink()}]" class="btn btn-danger" role="getLogoutLink">
                <i class="fas fa-off"></i> [{oxmultilang ident="LOGOUT"}]
            </a>
        </div>
        <p>&nbsp;</p>
    </div>
